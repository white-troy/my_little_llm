...
import tiktoken
import torch
from model_set.base_model import GPT,Model_args

checkpoint_save_dir = './chat/checkpoints'
device = 'cuda'
device_type = 'cuda'
# bfloat16
dtype = 'float16' # RuntimeError: Current CUDA Device does not support bfloat16. Please switch dtype to float16.
ptdtype = {'float32': torch.float32, 'bfloat16': torch.bfloat16, 'float16': torch.float16}[dtype]

# generate参数
top_k = 200
temperature = 1 # 一般都先设置1，想要更random一点就往上调
start = "广州恒大足球场位于" # 这是最开始的输入
...
enc = tiktoken.get_encoding("cl100k_base")# gpt2 tokenizer
